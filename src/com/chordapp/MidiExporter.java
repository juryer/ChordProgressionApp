...
public class MidiExporter {
    ...
    private static int[] getChordNotes(String chord) {
        ...
        if (suffix.equals("add9")) return new int[]{rootNote, rootNote+4, rootNote+7, rootNote+14};
     // デフォルト: メジャー3和音
    ...
    public static void export(Song song, int bpm, File outputFile,
        ...
        // ── 拍子記号設定 ──────────────────────────────────────────────────
        // numerator=拍数, denominator=音符の種類（2=2分,4=4分,8=8分）
        int denominator = (beatsPerBar == 6) ? 8 : 4;
